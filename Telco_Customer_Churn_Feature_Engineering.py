...
# Problem: Sirketi terk edecek musterileri tahmin eden bir model olusturmak,
# ancak modeli gelistirmeden once gerekli olan veri analizi ve feature engineering adimlarini gerceklestirmemiz gerekir.
...
# TotalCharges sayisal bir degisken
df["TotalCharges"] = pd.to_numeric(df["TotalCharges"], errors='coerce') # errors='coerce' for convert bad non numeric values to NaN
...
# Kategorik degiskenlerin target'a gore analizi
...
# aylık ödenecek miktarlarıyla totalcharge doldurulabilir, denenebilir veya missing olan 11 değişken drop edilebilir
...
# Tenure'dan yillik kategorik degisken olusturma
